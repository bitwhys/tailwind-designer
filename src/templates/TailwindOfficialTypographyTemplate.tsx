...
export type TailwindOfficialTypographyTemplateProps = {}

const TailwindOfficialTypographyTemplate =
  ({}: TailwindOfficialTypographyTemplateProps) => {
    return (
      <div className="prose prose-slate mx-auto mt-8">
        <p className="lead">
...
export default TailwindOfficialTypographyTemplate
